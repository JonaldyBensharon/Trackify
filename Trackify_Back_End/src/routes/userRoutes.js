...
// Update foto profil
router.post('/update-profile-picture', authenticateToken, userController.updateProfilePic);

// Hapus foto profil
router.delete('/remove-profile-picture', authenticateToken, userController.deleteProfilePic);
